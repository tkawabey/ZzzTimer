...
public abstract class PurchaseObserver {
    ...
    private void initCompatibilityLayer() {
    	if (MyLog.isDebugMod()) {MyLog.logf(TAG, "initCompatibilityLayer start");}
        try {
        	...
        	if (MyLog.isDebugMod()) {MyLog.logf(TAG, "initCompatibilityLayer end");}
        }
    }

    void startBuyPageActivity(PendingIntent pendingIntent, Intent intent) {
    	if (MyLog.isDebugMod()) {MyLog.logf(TAG, "startBuyPageActivity start");}
        ...
        if (MyLog.isDebugMod()) {MyLog.logf(TAG, "startBuyPageActivity end");}
    }
    ...
    void postPurchaseStateChange(final PurchaseState purchaseState, final String itemId,
        ...
        mHandler.post(new Runnable() {
            ...
            public void run() {
            	if (MyLog.isDebugMod()) {
            		MyLog.logf(TAG, "postPurchaseStateChange::run");
